...
public class RegisteredLetterTest extends LetterTest {
	...
	public Letter<?> getTestedLetter() {
		return new RegisteredLetter(new SimpleLetter(this.getSender(), this.getRecipient(), new Text("letter content")));
	}
	...
	public void acknowledgmentLetterSentTest() {
		...
		assertTrue("The letter in the mailBox should be an instance of an AcknowledgementOfReceipt", letterInTheMailBox instanceof AcknowledgementOfReceipt);
	}
